package com.ec.search.service;

import com.ec.search.client.BrandClient;
import com.ec.search.client.CategoryClient;
import com.ec.search.client.GoodsClient;
import com.ec.search.client.SpecClient;
...
import com.lh.ec.common.utils.NumberUtils;
import com.lh.ec.item.pojo.*;
...
//        return new SearchResult(total, totalPage, items, categories, brands, specs);
        ...
        return new SearchResult(pageInfo.getTotalElements(), pageInfo.getTotalPages(),
                pageInfo.getContent(), null, null, null);
    }
