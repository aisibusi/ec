...
public class GlobalCorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://manage.ec.com");
        config.addAllowedOrigin("http://www.ec.com");
        config.addAllowedOrigin("http://api.ec.com");
        config.addAllowedOrigin("https://api.ec.com");
        ...
        config.addAllowedOrigin("https://api.leyou.com");
        //2) 是否发送Cookie信息
